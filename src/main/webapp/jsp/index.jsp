        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="col-md-6 col-sm-6 services-num services-num-text-right">
                ...
                <div class="desc">
                    ...
                    <h3>Стандартный индекс (СИ) </h3>
                    <p>– стандартный индекс, наибольшая измеренная разовая концентрация примеси, деленная на ПДК. Характеризует степень кратковременного загрязнения. </p>
                </div>
            </div>
